<?php
	...
	if ( !empty($_SESSION['admin'] ) ) {
		...
		if (isset($_GET['edit'])) {
			$rid = protect($con, $_GET['edit']);
			$select_product = mysqli_query($con, "SELECT * FROM `products` WHERE product_id = '$rid'");
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="edit_product_process.php" method="POST" enctype="multipart/form-data" name="product_add">
                <input type="hidden" name="id" value="<?php echo $rid; ?>">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="product_number">Product Number:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="product_number" name="product_number" placeholder="Product_number" value="<?php echo $product['product_number']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="product_name">Product Name:</label>
                    <div class="col-sm-10"> 
                        <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Prodct Name" value="<?php echo $product['product_name']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="category" name="product_category">
                            ...
                            ?>
                            <option <?php echo ($product['product_category']==$category['category_name'])?'selected':'' ?>><?php echo $category['category_name']; ?></option>
                            <?php
                                }
                            ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"> 
                        <input type="text" class="form-control" id="price_per_unit" name="price_per_unit" placeholder="Price Per Unit" value="<?php echo $product['price_per_unit']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="stock">Stock:</label>
                    <div class="col-sm-10"> 
                        <input type="number" class="form-control" id="stock" name="stock" placeholder="In Stock" value="<?php echo $product['in_stock']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="min_quantity">Minimum Quantity:</label>
                    <div class="col-sm-10"> 
                        <input type="number" class="form-control" id="min_quantity" name="min_quantity" placeholder="Minimum Quantity" value="<?php echo $product['min_quantity']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="max_quantity">Maximum Quantity:</label>
                    <div class="col-sm-10"> 
                        <input type="number" class="form-control" id="max_quantity" name="max_quantity" placeholder="Maximum Quantity" value="<?php echo $product['max_quantity']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10 gallery_wrap" id="gallery">
                        <div id="display_img">
                            <p>Click to remove images</p>
                            <?php
                                for($j=0; $j<count($images); $j++) {
                            ?>
                            <div style="display: inline-block">
                                <img src="<?php echo $images[$j]; ?>" style="width: 60px; height: 60px" class="pr_img">
                                <input type="hidden" name="product_img[]" value="<?php echo $images[$j]; ?>">
                            </div>
                            <?php
                                }
                            ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="color-checkboxes">
                            ...
                            ?>
                            <input class="color-checkbox__input" type="checkbox" id="col-<?php echo $color['id']; ?>" value="<?php echo $color['color_code']; ?>" name="product_color[]" <?php if (in_array($color['color_code'], $colors)){ echo "checked"; } ?>/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 sp_wrap">
                        <div class="spec-wrap">
                            <input type="text" class="form-control" id="specification_name[]" name="specification_name[]" placeholder="Name" value="<?php echo $specifications[0][0]; ?>">
                            <input type="text" class="form-control" id="specification_value[]" name="specification_value[]" placeholder="Value" value="<?php echo $specifications[0][1]; ?>">
                        ...
                        ?>
                        <div class="spec-wrap">
                            <input type="text" class="form-control" id="specification_name[]" name="specification_name[]" placeholder="Name" value="<?php echo $specifications[$i][0]; ?>">
                            <input type="text" class="form-control" id="specification_value[]" name="specification_value[]" placeholder="Value" value="<?php echo $specifications[$i][1]; ?>">
                            <a href="javascript:void(0);" class="btn btn-info" id="add_spec"><i class="fa fa-plus"></i></a>
                            <a href="javascript:void(0);" class="btn btn-danger" id="remove_spec"><i class="fa fa-close"></i></a>
                        </div>
                        <?php
                            }
                        ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"> 
                        <textarea class="form-control" rows="5" id="product_description" name="product_description" placeholder="Product Description"><?php echo $product['description']; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="additional_information">Additional Information:</label>
                    <div class="col-sm-10"> 
                        <textarea class="form-control" rows="5" id="additional_information" name="additional_information" placeholder="Additional Information"><?php echo $product['additional_information']; ?></textarea>
                    </div>
                </div>
                <div class="form-group"> 
...
<script>
    $(function() {
        var image = $(".pr_img");
        $("#display_img").on('click', '.pr_img', function(e) {
