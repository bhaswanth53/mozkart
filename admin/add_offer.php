...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="">
                <form action="add_offer_process.php" method="POST" class="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="offer_title" id="offer_title" class="form-control" placeholder="Offer Title">
                    </div>
                    <div class="form-group">
                        <label for="discount_price">Discount Percentage:</label>
                        <input type="number" name="discount_price" id="discount_price" class="form-control" placeholder="Discount(in percentage)">
                    </div>
                    <div class="form-group">
                        <label for="expiry_date">Expiry Date:</label>
                        <input type="date" name="expiry_date" id="expiry_date" class="form-control" placeholder="Expiry Date" min="<?php echo $date; ?>">
                    </div>
                    <div class="form-group">
                        <label for="offer_description">Description:</label>
                        <textarea class="form-control" rows='5' id="offer_description" name="offer_description"></textarea>
                    </div>
