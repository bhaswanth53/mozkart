<?php
    ...
    if( !empty( $_SESSION['email'] ) ) {
        ...
        if ( isset( $_GET['failure'] ) ) {
            $order_number = base64_decode($_GET['failure']);
            $select = mysqli_query($con, "SELECT * FROM `orders` WHERE order_number = '$order_number'");
        }
        else {
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="">
                        ...
                        <h2 class="text-danger bold text-center"><?php echo $prder_number; ?></h2>
                    </div>
                </div>
            </div>
